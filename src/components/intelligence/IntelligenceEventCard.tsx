...
const CAT_COLORS: Record<string, string> = {
  ...
  cybersecurity:  "border-fuchsia-500/40 text-fuchsia-700",
  geopolitics:    "border-amber-glow/40 text-amber-glow",
  earthquake:     "border-orange-500/40 text-orange-700",
  disaster:       "border-orange-500/40 text-orange-700",
  economy:        "border-emerald-glow/40 text-emerald-glow",
  finance:        "border-emerald-glow/40 text-emerald-glow",
  energy:         "border-yellow-500/40 text-yellow-700",
  climate:        "border-sky-500/40 text-sky-700",
  weather:        "border-sky-500/40 text-sky-700",
  health:         "border-pink-500/40 text-pink-700",
  technology:     "border-cyan-glow/40 text-cyan-glow",
  diplomacy:      "border-violet-500/40 text-violet-700",
  space:          "border-indigo-500/40 text-indigo-700",
  infrastructure: "border-zinc-500/40 text-zinc-700",
  transportation: "border-zinc-500/40 text-zinc-700",
  migration:      "border-teal-500/40 text-teal-700",
  crime:          "border-red-500/40 text-red-700",
  science:        "border-cyan-glow/40 text-cyan-glow",
  environment:    "border-green-500/40 text-green-700",
